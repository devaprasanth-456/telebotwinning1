...
// --- Configuration (Copied from live traffic analysis) ---
const CONFIG = {
    // Using 'lifecycle' endpoint as observed in browser network tab
...
// Start first attempt when script runs directly via Node CLI
main();
